            ...
            transparent.pricing_plans.map(trans =>
                    ...
                    <ul>
                        {
                            trans.features.map((feature, index) =>
                                <li className="text-white " key={index}><span className="bg-white bg-clip-text text-transparent">✔</span> {feature}</li>
                            )
                        }
                    </ul>
                ...
                <div key= {trans.id} className="space-y-5 p-5 rounded-2xl flex flex-col  bg-[#F2F2F2] border-gray-600 ">
                    ...
                    <ul>
                        {
                            trans.features.map((feature, index) =>
                                <li key={index}><span className="bg-green-500 bg-clip-text text-transparent">✔</span> {feature}</li>
                            )
                        }
                    </ul>
