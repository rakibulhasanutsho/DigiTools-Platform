    ...
    <div className="dropdown">
      <div tabIndex={0} role="button" className="btn btn-ghost lg:hidden">
       ...
       <ul className="menu menu-sm dropdown-content bg-base-100 rounded-box z-1 mt-3 w-52 p-2 shadow ">
        <li className='cursor-pointer border border-gray-100'><a>Products</a></li>
        <li className='cursor-pointer border border-gray-100'><a >Features</a></li>
        <li className='cursor-pointer border border-gray-100'><a >Pricing</a></li>
        <li className='cursor-pointer border border-gray-100'><a>Testimonials</a></li>
        <li className='cursor-pointer border border-gray-100'><a>FAQ</a></li>
    </ul> 
