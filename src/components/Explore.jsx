...
export default  function Explore() {
  return (
    <div className="  bg-gradient-to-r from-[#4F39F6] to-[#9514FA] p-5 lg:p-30 text-center space-y-5">
       ...
       <div className="flex flex-col lg:flex-row justify-center gap-3">
        ...
        <button className="btn btn-outline border border-white text-white">View Pricing</button>
       </div>
    </div>
  );
}