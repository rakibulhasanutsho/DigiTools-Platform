...
export const Banner = () => {
  return (
    <div className='p-5 w-full lg:w-[1140px] mx-auto flex flex-col lg:flex-row gap-10 my-15 items-center  lg:text-left'>
        <div className='space-y-4'>
            ...
            <h2 className='text-[48px] lg:text-[64px] font-extrabold leading-[84px] text-[#101727] '>Supercharge Your Digital Workflow</h2>
